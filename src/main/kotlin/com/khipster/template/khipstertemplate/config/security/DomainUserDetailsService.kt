...
class DomainUserDetailsService(private val authRepo: AuthRepo) : UserDetailsService {
    ...
    override fun loadUserByUsername(login: String): UserDetails {
        ...
        if (EmailValidator().isValid(login, null)) {
            return authRepo.findOneWithAuthoritiesByEmailIgnoreCase(login)
        ...
        return authRepo.findOneWithAuthoritiesByLogin(lowercaseLogin)
